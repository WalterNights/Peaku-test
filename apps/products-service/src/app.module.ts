  ...
  imports: [
    ...
    MongooseModule.forRootAsync({
      ...
      useFactory: (config: ConfigService) => ({
        ...
        // sanitizeFilter envuelve valores user-provided en $eq → bloquea
        // inyección de operadores Mongo. Reemplaza al deprecated
        // express-mongo-sanitize. Ver docs/04-seguridad.md §5.2.
        sanitizeFilter: true,
      }),
    }),
    ProductsModule,
